...
import com.songwj.openvideo.opengl.Camera2FilterPreviewGLSurface
import kotlinx.android.synthetic.main.activity_camera2_preview.*

class Camera2PreviewGLSurfaceFilterActivity : AppCompatActivity() {
    private var glSurfaceView: Camera2FilterPreviewGLSurface? = null
...
//                glSurfaceView?.onRenderDestroy()
    ...
    private fun attachPreviewGLSurface(width: Int,
        ...
        glSurfaceView = Camera2FilterPreviewGLSurface(this)
        ...
        camera_container.addView(glSurfaceView, lp)
