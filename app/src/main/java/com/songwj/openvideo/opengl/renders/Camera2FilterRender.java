...
import com.songwj.openvideo.opengl.Camera2FilterGLSurfaceView;
...
public class Camera2FilterRender implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    private static final String TAG = "Camera1RecordRender";

    private Camera2FilterGLSurfaceView glSurfaceView;
    ...
    public Camera2FilterRender(Camera2FilterGLSurfaceView glSurfaceView) {
