 ...
 *
 */
class FlashWhiteVideoDrawer : IDrawer {
    /**上下颠倒的顶点矩阵*/
...
//--------------------------------------
    ...
    private fun initDefMatrix() {
        ...
        if (mVideoWidth != -1 && mVideoHeight != -1 &&
            ...
            Log.e("FlashWhiteVideoDrawer", "width: $mWorldWidth, height: $mWorldHeight," +
    ...
    private fun getFragmentShader(): String {
        ...
        return "#extension GL_OES_EGL_image_external : require\n" +
                ...
                "void main() {" +
                    ...
                    "vec4 soulMask = texture2D(uSoulTexture, vCoordinate);" +
                    "vec4 color = texture2D(uTexture, vCoordinate);" +

                    "if (drawFbo == 0) {" +
                    // 颜色混合 默认颜色混合方程式 = mask * (1.0-alpha) + weakMask * alpha
                    "    gl_FragColor = soulMask * (1.0 - amplitude) + whiteMask * amplitude;" +
                    "} else {" +
