...
class VideoDrawer : IDrawer {
    ...
    private fun initDefMatrix() {
        ...
        if (mVideoWidth != -1 && mVideoHeight != -1 &&
            ...
            Log.e("VideoDrawer", "width: $mWorldWidth, height: $mWorldHeight," +
    ...
    fun translate(dx: Float, dy: Float) {
        if (mVideoRotation == 0) {
            ...
            if (mVideoRotation % 270 == 0) {
                Matrix.translateM(mMatrix, 0, -dy*mHeightRatio*2, -dx*mWidthRatio*2, 0f)
            }
            else if (mVideoRotation % 180 == 0) {
                Matrix.translateM(mMatrix, 0, dx*mWidthRatio*2, -dy*mHeightRatio*2, 0f)
            }
            else {
                Matrix.translateM(mMatrix, 0, dy*mHeightRatio*2, dx*mWidthRatio*2, 0f)
    ...
    fun scale(sx: Float, sy: Float, sz: Float) {
        mMatrix?.let {
            Log.e("scale", "setWorldSize: $sx, $sy")
