...
import com.songwj.openvideo.camera.GestureGLSurfaceView;

public class AspectRatioGestureGLSurfaceView extends GestureGLSurfaceView {
    ...
    private AspectRatioMode ratioMode = AspectRatioMode.EQUAL_PROPORTION_FIT_PARENT;
    ...
    public AspectRatioGestureGLSurfaceView(Context context) {
        super(context);
    }

    public AspectRatioGestureGLSurfaceView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
