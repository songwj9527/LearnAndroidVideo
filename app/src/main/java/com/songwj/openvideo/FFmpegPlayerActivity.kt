...
class FFmpegPlayerActivity : AppCompatActivity() , TextureView.SurfaceTextureListener {
...
//        nativePlayer?.setDataSource("https://fg-im.oss-cn-hangzhou.aliyuncs.com/develop/2020/04/08/15863400286359235045891VID_20200327_155101.mp4")
...
//                nativePlayer?.setSurface(surface)
        ...
        nativePlayer?.setOnInfoListener(object : NativePlayer.OnInfoListener {
            override fun onInfo(
                ...
                texture_view = TextureRenderView(this@FFmpegPlayerActivity)
                ...
                texture_view?.setSurfaceTextureListener(this@FFmpegPlayerActivity)
