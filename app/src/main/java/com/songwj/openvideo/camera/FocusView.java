...
public class FocusView extends View {
    ...
    public FocusView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        radiusOuter = resources.getDimensionPixelSize(R.dimen.focus_radius_outer);
        radiusInner = resources.getDimensionPixelSize(R.dimen.focus_radius_inner);
        strokeWidth = resources.getDimensionPixelSize(R.dimen.focus_stroke_width);
