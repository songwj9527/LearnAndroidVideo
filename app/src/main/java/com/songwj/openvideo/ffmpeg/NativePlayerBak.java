...
public class NativePlayerBak {
    ...
    private State statePrev = State.IDLE;
    ...
    public void setDataSource(String url) {
        if (nativePlayer == null) {
            synchronized(NativePlayerBak.class) {
                if (nativePlayer == null) {
...
//            resetListener();
    ...
    private static void postEventFromNative(Object weakThis, int what, int arg1, int arg2, Object obj) {
        if (weakThis != null) {
            NativePlayerBak nativePlayer = null;
            if (weakThis instanceof WeakReference) {
                nativePlayer = ((WeakReference<NativePlayerBak>) weakThis).get();
            } else if (weakThis instanceof NativePlayerBak) {
                nativePlayer = (NativePlayerBak) weakThis;
            }
    ...
    private static final int NATIVE_CALLBACK_EVENT_BUFFERING_UPDATE     = 4;
    private static final int NATIVE_CALLBACK_EVENT_POSITION_UPDATE      = 5;
    ...
    private class EventHandler extends Handler {
        private final WeakReference<NativePlayerBak> weakNativePlayer;
        public EventHandler(NativePlayerBak nativePlayer, Looper looper) {
            super(looper);
            ...
            if (msg != null) {
                ...
                switch (code) {
                    case NATIVE_CALLBACK_EVENT_PREPARED:
                        NativePlayerBak player1 = weakNativePlayer.get();
                    ...
                    case NATIVE_CALLBACK_EVENT_INFO:
                        NativePlayerBak player2 = weakNativePlayer.get();
                        if (player2 != null && player2.onInfoListener != null) {
                            player2.onInfoListener.onInfo(player2, msg.arg1, msg.arg2, (int) msg.obj);
                        }
                        break;
                    case NATIVE_CALLBACK_EVENT_BUFFERING_UPDATE:
                        NativePlayerBak player4 = weakNativePlayer.get();
                        ...
                        break;
                    case NATIVE_CALLBACK_EVENT_POSITION_UPDATE:
                        NativePlayerBak player5 = weakNativePlayer.get();
                        if (player5 != null && player5.onPositionUpdateListener != null) {
                            player5.onPositionUpdateListener.onPositionUpdate(player5, msg.arg1);
                        }
                        break;
                    case NATIVE_CALLBACK_EVENT_COMPLETED:
                        NativePlayerBak player6 = weakNativePlayer.get();
                    ...
                    case NATIVE_CALLBACK_EVENT_SEEK_COMPLETED:
                        NativePlayerBak player7 = weakNativePlayer.get();
                        state = statePrev;
                    ...
                    case NATIVE_CALLBACK_EVENT_ERROR:
                        NativePlayerBak player8 = weakNativePlayer.get();
    ...
    public interface OnPreparedListener {
        public void onPrepared(NativePlayerBak player);
    }

    public interface OnInfoListener {
        public void onInfo(NativePlayerBak player, int videoWidth, int videoHeight, int videoRotation);
    }

    public interface OnSeekCompletedListener {
        public void onSeekCompleted(NativePlayerBak player);
    }

    public interface OnBufferingUpdateListener {
        public void onBufferingUpdate(NativePlayerBak player, int progress);
    }

    public interface OnPositionUpdateListener {
        public void onPositionUpdate(NativePlayerBak player, long progress);
    }

    public interface OnCompletedListener {
        public void onCompleted(NativePlayerBak player);
    }

    public interface OnErrorListener {
        public void onError(NativePlayerBak player, int what, int extra, String msg);
    }
}
