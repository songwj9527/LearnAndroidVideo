...
import com.songwj.openvideo.opengl.egl.CustomerGLSurfaceTextureRender
import kotlinx.android.synthetic.main.activity_egl_player_texture_view.*

class EGLPlayerTextureViewActivity : AppCompatActivity() {
    ...
    private var renderer = CustomerGLSurfaceTextureRender()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_egl_player_texture_view)
...
//                    }, 100)
        ...
        initFirstRender()
        initSecondRender()
        renderer.setSurface(texture_view)
        texture_view.surfaceTextureListener = object : TextureView.SurfaceTextureListener {
            override fun onSurfaceTextureAvailable(
                ...
                renderer.onSurfaceTextureAvailable(surface, width, height)
            }
            ...
            override fun onSurfaceTextureSizeChanged(
                ...
                renderer.onSurfaceTextureSizeChanged(surface, width, height)
            }

            override fun onSurfaceTextureDestroyed(surface: SurfaceTexture?): Boolean {
                return renderer.onSurfaceTextureDestroyed(surface)
            }

            override fun onSurfaceTextureUpdated(surface: SurfaceTexture?) {
                renderer.onSurfaceTextureUpdated(surface)
            }
